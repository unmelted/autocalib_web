...
CREATE TABLE IF NOT EXISTS multi_tracker (tracker_task_id TEXT PRIMARY KEY NOT NULL, task_id TEXT NOT NULL, createdate TIMESTAMP DEFAULT NOW(), cam_count INTEGER, info_map TEXT, kairos_task_id TEXT, command_status TEXT, run_status TEXT);
