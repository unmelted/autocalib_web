CREATE TABLE IF NOT EXISTS task (task_no INTEGER NOT NULL, task_id TEXT PRIMARY KEY NOT NULL, createdate TIMESTAMP DEFAULT NOW(), task_type TEXT, task_path TEXT, event_id TEXT, event_type TEXT, alias TEXT, wherefrom TEXT);
...
CREATE TABLE IF NOT EXISTS multi_tracker (tracker_task_id TEXT PRIMARY KEY NOT NULL, task_id TEXT NOT NULL, createdate TIMESTAMP DEFAULT NOW(), cam_count INTEGER, info_map TEXT, kairos_task_id INTEGER, command_status TEXT, run_status TEXT);
